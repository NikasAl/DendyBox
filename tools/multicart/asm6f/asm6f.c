...
byte bpl[]={0x10,REL,-1,-1};
byte clc[]={0x18,IMP,-1,-1};
byte jsr[]={0x20,ABS,-1,-1};
byte and[]={0x29,IMM,0x21,INDX,0x31,INDY,0x35,ZPX,0x3d,ABSX,0x39,ABSY,0x25,ZP,0x2d,ABS,-1,-1};
byte bit[]={0x24,ZP,0x2c,ABS,-1,-1};
byte rol[]={0x2a,ACC,0x36,ZPX,0x3e,ABSX,0x26,ZP,0x2e,ABS,0x2a,IMP,-1,-1};
byte plp[]={0x28,IMP,-1,-1};
byte bmi[]={0x30,REL,-1,-1};
byte sec[]={0x38,IMP,-1,-1};
byte rti[]={0x40,IMP,-1,-1};
byte eor[]={0x49,IMM,0x41,INDX,0x51,INDY,0x55,ZPX,0x5d,ABSX,0x59,ABSY,0x45,ZP,0x4d,ABS,-1,-1};
byte lsr[]={0x4a,ACC,0x56,ZPX,0x5e,ABSX,0x46,ZP,0x4e,ABS,0x4a,IMP,-1,-1};
byte pha[]={0x48,IMP,-1,-1};
byte jmp[]={0x6c,IND,0x4c,ABS,-1,-1};
byte bvc[]={0x50,REL,-1,-1};
byte cli[]={0x58,IMP,-1,-1};
byte rts[]={0x60,IMP,-1,-1};
byte adc[]={0x69,IMM,0x61,INDX,0x71,INDY,0x75,ZPX,0x7d,ABSX,0x79,ABSY,0x65,ZP,0x6d,ABS,-1,-1};
byte ror[]={0x6a,ACC,0x76,ZPX,0x7e,ABSX,0x66,ZP,0x6e,ABS,0x6a,IMP,-1,-1};
byte pla[]={0x68,IMP,-1,-1};
byte bvs[]={0x70,REL,-1,-1};
byte sei[]={0x78,IMP,-1,-1};
byte sta[]={0x81,INDX,0x91,INDY,0x95,ZPX,0x9d,ABSX,0x99,ABSY,0x85,ZP,0x8d,ABS,-1,-1};
byte sty[]={0x94,ZPX,0x84,ZP,0x8c,ABS,-1,-1};
byte stx[]={0x96,ZPY,0x86,ZP,0x8e,ABS,-1,-1};
byte dey[]={0x88,IMP,-1,-1};
byte txa[]={0x8a,IMP,-1,-1};
byte bcc[]={0x90,REL,-1,-1};
byte tya[]={0x98,IMP,-1,-1};
byte txs[]={0x9a,IMP,-1,-1};
byte ldy[]={0xa0,IMM,0xb4,ZPX,0xbc,ABSX,0xa4,ZP,0xac,ABS,-1,-1};
byte lda[]={0xa9,IMM,0xa1,INDX,0xb1,INDY,0xb5,ZPX,0xbd,ABSX,0xb9,ABSY,0xa5,ZP,0xad,ABS,-1,-1};
byte ldx[]={0xa2,IMM,0xb6,ZPY,0xbe,ABSY,0xa6,ZP,0xae,ABS,-1,-1};
byte tay[]={0xa8,IMP,-1,-1};
byte tax[]={0xaa,IMP,-1,-1};
byte bcs[]={0xb0,REL,-1,-1};
byte clv[]={0xb8,IMP,-1,-1};
byte tsx[]={0xba,IMP,-1,-1};
byte cpy[]={0xc0,IMM,0xc4,ZP,0xcc,ABS,-1,-1};
byte cmp[]={0xc9,IMM,0xc1,INDX,0xd1,INDY,0xd5,ZPX,0xdd,ABSX,0xd9,ABSY,0xc5,ZP,0xcd,ABS,-1,-1};
byte dec[]={0xd6,ZPX,0xde,ABSX,0xc6,ZP,0xce,ABS,-1,-1};
byte iny[]={0xc8,IMP,-1,-1};
byte dex[]={0xca,IMP,-1,-1};
byte bne[]={0xd0,REL,-1,-1};
byte cld[]={0xd8,IMP,-1,-1};
byte cpx[]={0xe0,IMM,0xe4,ZP,0xec,ABS,-1,-1};
byte sbc[]={0xe9,IMM,0xe1,INDX,0xf1,INDY,0xf5,ZPX,0xfd,ABSX,0xf9,ABSY,0xe5,ZP,0xed,ABS,-1,-1};
byte inc[]={0xf6,ZPX,0xfe,ABSX,0xe6,ZP,0xee,ABS,-1,-1};
byte inx[]={0xe8,IMP,-1,-1};
byte nop[]={0xea,IMP,-1,-1};
byte beq[]={0xf0,REL,-1,-1};
byte sed[]={0xf8,IMP,-1,-1};

// asm6f addition:
/* Undocumented/Illegal Opcodes (NMOS 6502 only!) */
// names/information taken from http://www.oxyron.de/html/opcodes02.html

byte slo[]={0x03,INDX,0x13,INDY,0x17,ZPX,0x1f,ABSX,0x1b,ABSY,0x07,ZP,0x0f,ABS,-1,-1};
byte rla[]={0x23,INDX,0x33,INDY,0x37,ZPX,0x3f,ABSX,0x3b,ABSY,0x27,ZP,0x2f,ABS,-1,-1};
byte sre[]={0x43,INDX,0x53,INDY,0x57,ZPX,0x5f,ABSX,0x5b,ABSY,0x47,ZP,0x4f,ABS,-1,-1};
byte rra[]={0x63,INDX,0x73,INDY,0x77,ZPX,0x7f,ABSX,0x7b,ABSY,0x67,ZP,0x6f,ABS,-1,-1};
byte sax[]={0x83,INDX,0x97,ZPY,0x87,ZP,0x8f,ABS,-1,-1};
byte lax[]={0xa3,INDX,0xb3,INDY,0xb7,ZPY,0xbf,ABSY,0xa7,ZP,0xaf,ABS,-1,-1};
byte dcp[]={0xc3,INDX,0xd3,INDY,0xd7,ZPX,0xdf,ABSX,0xdb,ABSY,0xc7,ZP,0xcf,ABS,-1,-1};
byte isc[]={0xe3,INDX,0xf3,INDY,0xf7,ZPX,0xff,ABSX,0xfb,ABSY,0xe7,ZP,0xef,ABS,-1,-1};

byte anc[]={0x0b,IMM,-1,-1}; // has duplicate at 0x2b

byte alr[]={0x4b,IMM,-1,-1};
byte arr[]={0x6b,IMM,-1,-1};
byte axs[]={0xcb,IMM,-1,-1};
byte las[]={0xbb,ABSY,-1,-1};

// "unstable in certain matters":
byte ahx[]={0x93,INDY,0x9f,ABSY,-1,-1};
byte shy[]={0x9c,ABSX,-1,-1};
byte shx[]={0x9e,ABSY,-1,-1};
byte tas[]={0x9b,ABSY,-1,-1};
